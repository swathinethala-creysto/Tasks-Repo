...
function UnSubscribe() {
  ...
  const handleSubscribe = () => {
    setOpen(true);
    axios
      .get(`http://216.48.182.12:5555/opt_out?number=${number}`)
      .then((res) => {
        ...
        >
          ...
          <div className="d-flex flex-column p-3">
            ...
            <div>
              ...
              <span className="fw-bold fs-5"> Turn-off </span>
              <span className="fs-5">
                receiving important information and updates over{" "}
              </span>
      ...
      {stateData.isFinished && (
        <>
          <div className="back_data">
            <div
              className="p-3 rounded-5 h-20 d-flex flex-column justify-content-center align-items-center"
              style={{
                paddingTop: 10,
                paddingBottom: 50,
                backgroundColor: "#f2f2f2",
            ...
            >
              <div>
                ...
                <p className="fs-4"><br/>
                  You have been successfully un-subscribed to notification and
